        ...
        <native:column center class="w-full py-4">
            <native:column center class="w-full p-3 bg-theme-surface rounded-2xl shadow-md">
                ...
                @if (!empty($generalError))
                    <native:column
                        class="w-full p-3 mb-3 bg-red-100 dark:bg-red-900/30 rounded-xl border border-red-400">
                ...
                <native:outlined-text-input size="sm" label="Username" native:model.debounce.300ms="username"
                    leading-icon="person" class="w-full mb-3 text-theme-on-surface" :is-error="!empty($usernameError)"
                    :supporting="$usernameError" />

                <native:outlined-text-input size="sm" label="Password" native:model.debounce.300ms="password"
                    leading-icon="lock" class="w-full mb-4" secure :is-error="!empty($passwordError)"
